...
Route::get('/login', [VendorAuthController::class, 'Login'])->middleware('alreadyLoggedIn');
...
Route::get('/dashboard', [VendorAuthController::class, 'Dashboard'])->middleware('isLoggedIn');
